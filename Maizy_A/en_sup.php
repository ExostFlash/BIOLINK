    ...
    if ($stmt->execute()) {
        ...
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/BIOLINK/Maizy_A/?lang=EN';
				</script>
				";
    } else {
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/BIOLINK/Maizy_A/?lang=EN&page=account';
				</script>
				";
    }
}
    ...
    if ($mdp === $recup['mdp']) {
        ...
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/BIOLINK/Maizy_A/?lang=EN&page=single-post&id_post=" . $id_post_page . "';
				</script>
				";
    } else {
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/BIOLINK/Maizy_A/?lang=EN&page=account&id_post=" . $id_post_page . "';
				</script>
				";
    }
}
