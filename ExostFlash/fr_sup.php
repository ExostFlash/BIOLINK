...
if (isset($_REQUEST['btn_contact'])) {
    ...
    $contenu = "<br />Monsieur " . $name . " vous venez de contacter <b>Amaury MAIZY</b> via le site internet <a href='https://ef-biolink.ovh/ExostFlash/'>BioLink ExostFlash</a>";
    $contenu .= "<br /><br />Message : " . $message;
...
if (isset($_REQUEST['btn_inscription'])) {
    ...
    if ($stmt->execute()) {
        ...
        $contenu = "<br />Monsieur " . $nom . " vous venez de vous inscrire via le site <a href='https://www.ef-biolink.ovh/ExostFlash/'>BioLink ExostFlash</a>";
        ...
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/ExostFlash/?lang=FR';
				</script>
				";
    } else {
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/ExostFlash/?lang=FR&page=account';
				</script>
				";
    }
}
    ...
    if ($mdp === $recup['mdp']) {
        ...
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/ExostFlash/?lang=FR&page=single-post&id_post=" . $id_post_page . "';
				</script>
				";
    } else {
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/ExostFlash/?lang=FR&page=account&id_post=" . $id_post_page . "';
				</script>
				";
    }
}
