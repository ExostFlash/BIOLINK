...
if (isset($_REQUEST['btn_contact'])) {
    ...
    $contenu = "<br />Monsieur " . $name . " vous venez de contacter <b>Amaury MAIZY</b> via le site internet <a href='https://exostflash.ovh/BIOLINK/ExostFlash/'>BioLink ExostFlash</a>";
    $contenu .= "<br /><br />Message : " . $message;
    ...
    if ($stmt->execute()) {
        ...
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/BIOLINK/ExostFlash/?lang=FR';
				</script>
				";
    } else {
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/BIOLINK/ExostFlash/?lang=FR&page=account';
				</script>
				";
    }
}
    ...
    if ($mdp === $recup['mdp']) {
        ...
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/BIOLINK/ExostFlash/?lang=FR&page=single-post&id_post=" . $id_post_page . "';
				</script>
				";
    } else {
        echo "
				<script language='javascript'>
					...
					javascript:window.location='/BIOLINK/ExostFlash/?lang=FR&page=account&id_post=" . $id_post_page . "';
				</script>
				";
    }
}
